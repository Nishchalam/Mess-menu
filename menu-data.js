...
export const commonItems = {
  ...
  Lunch: [
    ...
    "Sugar",
    "Papad/Fryums",
    "Salad (any three: Cucumber, Tomato, Beetroot, Radish, Carrot)",
    "Green Chilli"
  ],
  Dinner: [
...
//✅
  ...
  jain: {
    name: "North Indian - Pure Veg (Jain)",
    weeks: {
      A: {
        Monday: {
          Breakfast: ["Mango Jam", "Boiled Chole", "Oats", "Poha", "Tamarind Chutney"],
          Lunch: ["Rice", "Chapati", "Dal Makhani", "Aloo Gobi Capsicum Dry", "Chole Curry","Curd"],
          Snacks: ["Masalacorn & Lemon"],
          Dinner: ["Rice", "Phulka", "Chana Dal", "Malai Kofta / Raw Banana Kofta", "Boondi"]
        },
        Tuesday: {
          Breakfast: ["Mixed Fruit Jam", "Boiled Green Gram", "Chocos", "Kachori", "Imli Chutney", "Aloo Sabji"],
          Lunch: ["Rice", "Phulka", "Dal (Masoor)", "Bhindi Aloo Bhujia", "Red Pumpkin Chana Masala", "Tori Ki Sabzi (Sponge Gourd)","Curd"],
          Snacks: ["Mysore Bonda with coconut Chutney"],
          Dinner: ["Veg fried Rice", "Roti", "Toor Dal", "Veg Manchurian", "Watermelon Fruit", "Buttermilk"]
        },
        Wednesday: {
          Breakfast: ["Mango Jam", "Boiled Black Chana", "Oats", "Pav Bhaji", "Pav Bhaji Masala", "Aloo Bonda", "Bread Bajji"],
          Lunch: ["Rice", "Phulka", "Sweet Lassi", "Dal (Rajma)", "Carrot Peas foogath", "Peas Masala", "Aloo Baigan Tamatar Masala", "Sev Tamatar", "Detox Water"],
          Snacks: ["Rusk (4 pieces)"],
          Dinner: ["Ghee Rice", "Roti", "Masoor Dal", "Kadai Paneer", "Seasonal Fruit (Papaya, Orange, etc.)", "Lemon Juice"]
        },
        Thursday: {
          Breakfast: ["Mango Jam", "Green Gram Sprouts", "Oats", "Moong Dal Chilla", "Tomato + Onion", "Tomato Chutney"],
          Lunch: ["Rice", "Phulka", "Dal (Toor)", "Aloo Karela (dry)", "Lauki Chana Dal (Semi-dry)"],
          Snacks: ["Bhel Puri"],
          Dinner: ["Peas Pulao", "Methi Puri", "Dal Tadka", "Black Chana Curry", "Sabudhana Kheer"]
        },
        Friday: {
          Breakfast: ["Mixed Fruit Jam", "Millet Sprouts", "Cornflakes", "Semiya Khichdi", "Coconut Chutney"],
          Lunch: ["Rice", "Roti", "Dal (Chana)", "Cabbage Peas Dry", "Mix Veg Curry", "Fried Green Chilli"],
          Snacks: ["Butter Salted Popcorn"],
          Dinner: ["Rice", "Chapati", "Fried Dal", "Soya Chunk Curry", "Musk Melon Fruit", "Buttermilk"]
        },
        Saturday: {
          Breakfast: ["Pineapple Jam", "Boiled Green Gram", "Chocos", "Aloo Paratha", "Cabbage Paratha", "Curd", "Green Chutney"],
          Lunch: ["Rice", "Green Methi Paratha", "Mixed Dal Tadka", "Jeera Aloo", "Tindly Fry", "Ridge Gourd Masala"],
          Snacks: ["Bread Pakora with Sauce"],
          Dinner: ["Rice", "Roti", "Masoor Dal", "Tawa mix Veg Sabzi", "Banana Fruit", "Milk + Boost"]
        },
        Sunday: {
          Breakfast: ["Mango Jam", "Chole / Green Gram Sprouts", "Oats", "Plain Dosa", "Aloo Masala", "Mix Veg Sambar", "Coconut Chutney"],
          Lunch: ["Veg Hyderabadi Biryani", "Roti", "Dal (Toor Dal)", "Onion / Cucumber Raita", "Paneer Butter Masala", "Ice Cream"],
          Snacks: ["Chana Chaat"],
          Dinner: ["Rice", "Chole Bhature", "Dal (Moong)", "Mixed Fruit Salad", "Lemon Juice"]
        }
      },
      B: {
        Monday: {
          Breakfast: ["Pineapple Jam", "Millet Sprouts", "Cornflakes", "Poha", "Sev", "Tamarind Chutney"],
          Lunch: ["Rice", "Roti", "Dal Fry", "Jeera Aloo", "Sev Tamatar", "Kadi Pakoda"],
          Snacks: ["Biscuit packet"],
          Dinner: ["Rice", "Roti", "Channa Dal", "Bangara Baigan Dry", "Raw Banana Dry", "Rice Kheer"]
        },
        Tuesday: {
          Breakfast: ["Pineapple Jam", "Green Gram Sprouts", "Cornflakes", "Luchi", "Aloo dum", "Channa Masala", "Bengali Chana Dal"],
          Lunch: ["Rice", "Roti", "Dal (Masoor)", "Mix Veg Dry", "Aloo Saag Sabji", "Bhindi Fry", "Fried Green Chilli"],
          Snacks: ["Veg Cutlet - 2no"],
          Dinner: ["Fried Rice", "Roti", "Toor Dal", "Vegetable Manchurian", "Papaya Fruit", "Buttermilk"]
        },
        Wednesday: {
          Breakfast: ["Pineapple Jam", "Boiled Black Chana", "Cornflakes", "Rice Idli", "Medu Vada (no onion)", "Mix Veg Sambar", "Coconut Chutney"],
          Lunch: ["Rice", "Roti", "Dal (Rajma)", "Sweet Lassi", "Cabbage Peas Dry", "Aloo Parwal Curry", "Soya Beans Curry", "Detox Water"],
          Snacks: ["Masala Boiled Chana"],
          Dinner: ["Jeera Rice", "Roti", "Masoor Dal", "Shahi Paneer", "Muskmelon", "Lemon Juice"]
        },
        Thursday: {
          Breakfast: ["Mixed Fruit Jam", "Boiled Green Gram", "Chocos", "Macaroni", "Aloo Bonda", "Sauce"],
          Lunch: ["Rice", "Roti", "Dal (Urad)", "Mushroom Peas Aloo Masala", "Peas Masala", "Tindly Fry"],
          Snacks: ["Veg Puff / Bread Pakoda"],
          Dinner: ["Rice", "Roti", "Aloo Beans Dry", "Beans Dry", "Chole Curry", "Fruit Custard"]
        },
        Friday: {
          Breakfast: ["Mixed Fruit Jam", "Chole", "Green Gram", "Chocos", "Plain Utthappam", "Coconut Chutney", "Mix Veg Sambar"],
          Lunch: ["Rice", "Roti", "Chana Dal", "Chili Paneer Semi dry", "Kadai Mix Veg Curry"],
          Snacks: ["Sev Puri"],
          Dinner: ["Rice", "Roti", "Tomato Dal", "Kala Channa Masala Curry", "Watermelon Fruit", "Buttermilk"]
        },
        Saturday: {
          Breakfast: ["Mango Jam", "Boiled Chole", "Oats", "Poori", "Aloo Masala"],
          Lunch: ["Moong Dal Vegetable Khichdi", "Roti", "Dal (Toor)", "Green Leaf Sabji", "Aloo Gobhi Curry", "Chow Chow Curry", "Fried Green Chilli"],
          Snacks: ["Samosa - 1 no"],
          Dinner: ["Rice", "Roti", "Dal Makhani", "Lauki Chana Sabji", "Milk + Boost"]
        },
        Sunday: {
          Breakfast: ["Mango/Orange Jam", "Boiled Green Gram", "Oats", "Aloo/Gobi Paratha", "Green Chutney", "Curd"],
          Lunch: ["Mixed Veg Biryani", "Roti", "Raita", "Dal (Toor)", "Kadai Paneer", "Mirchi Ka Salan", "Onion+Tomato+Lemon Salad", "Gulab Jamun"],
          Snacks: ["Banana Cake/Rusk(4pcs)"],
          Dinner: ["Rice", "Dal Fry", "Puri", "Chana Masala", "Mixed Fruit Salad"]
        }
      },
      C: {
        Monday: {
          Breakfast: ["Mango Jam", "Boiled Chole", "Oats", "Poha", "Tamarind Chutney", "Jalebi"],
          Lunch: ["Rice", "Chapati", "Dal Makhani", "Gobi Capsicum Masala Dry", "Chole Curry Dry"],
          Snacks: ["Sambar Vada"],
          Dinner: ["Rice", "Phulka", "Chana Dal", "Malai Kofta / Raw Banana Kofta", "Boondi"]
        },
        Tuesday: {
          Breakfast: ["Mixed Fruit Jam", "Boiled Green Gram", "Chocos", "Kachoori", "Curd Chutney", "Aloo Sabji", "Raw Banana"],
          Lunch: ["Rice", "Phulka", "Dal (Masoor)", "Bhindi Aloo Bhujia", "Red Pumpkin Chana Masala", "Toi Ki Sabzi (Sponge Gourd)"],
          Snacks: ["Punugulu with Kara Chutney"],
          Dinner: ["Veg fried Rice", "Roti", "Toor Dal", "Veg Manchurian", "Watermelon Fruit", "Buttermilk"]
        },
        Wednesday: {
          Breakfast: ["Mango Jam", "Boiled Black Chana", "Oats", "Pav Bhaji", "Pav Bhaji Masala", "Aloo Bonda", "Bread Bajji"],
          Lunch: ["Rice", "Phulka", "Sweet Lassi", "Dal (Rajma)", "Carrot Peas", "Peas Masala", "Aloo Baigan Tamatar Masala", "Sev Tamatar", "Detox Water", "Mirchi Bhajji"],
          Snacks: ["Biscuit Packet"],
          Dinner: ["Ghee Rice", "Roti", "Masoor Dal", "Kadai Paneer", "Seasonal Fruit (Papaya, Orange, etc.)", "Lemon Juice"]
        },
        Thursday: {
        ...
        Saturday: {
          Breakfast: ["Pineapple Jam", "Boiled Green Gram", "Chocos", "Aloo Paratha", "Cabbage Paratha", "Curd", "Green Chutney"],
          Lunch: ["Rice", "Green Methi Paratha", "Mixed Dal Tadka", "Jeera Aloo", "Tindly Fry", "Ridge Gourd Masala"],
          Snacks: ["Aloo Bonda with sauce - 2pc"],
          Dinner: ["Rice", "Roti", "Masoor Dal", "Tawa mix Veg Sabzi", "Banana Fruit", "Milk + Boost"]
        },
        Sunday: {
          Breakfast: ["Mango Jam", "Chole / Green Gram Sprouts", "Oats", "Plain Dosa", "Aloo Masala", "Mix Veg Sambar", "Coconut Chutney"],
          Lunch: ["Veg Hyderabadi Biryani", "Roti", "Dal (Toor Dal)", "Onion / Cucumber Raita", "Paneer Butter Masala", "Sabu Tokda"],
          Snacks: ["Crispy Soyachunks"],
          Dinner: ["Rice", "Chole Bhature", "Dal (Moong)", "Mixed Fruit Salad", "Lemon Juice"]
        }
      },
      D: {
        ...
        Tuesday: {
          Breakfast: ["Pineapple Jam", "Green Gram Sprouts", "Cornflakes", "Luchi", "Aloo dum"],
          Lunch: ["Rice", "Roti", "Dal (Masoor)", "Mix Veg Dry", "Aloo Saag Sabji", "Bhindi Fry", "Fried Green Chilli"],
          Snacks: ["Chilli Bajji with sauce"],
          Dinner: ["Fried Rice", "Roti", "Toor Dal", "Vegetable Manchurian", "Papaya Fruit", "Buttermilk"]
        },
        Wednesday: {
          Breakfast: ["Pineapple Jam", "Boiled Black Chana", "Cornflakes", "Rice Idli", "Medu Vada (no onion)", "Mix Veg Sambar", "Coconut Chutney"],
          Lunch: ["Rice", "Roti", "Dal (Rajma)", "Sweet Lassi", "Cabbage Peas Dry", "Aloo Parwal Curry", "Soya Beans Curry", "Detox Water"],
          Snacks: ["French fries with sauce"],
          Dinner: ["Jeera Rice", "Roti", "Masoor Dal", "Shahi Paneer", "Muskmelon", "Lemon Juice"]
        },
        Thursday: {
          Breakfast: ["Mixed Fruit Jam", "Boiled Green Gram", "Chocos", "Maggi", "Sauce"],
          Lunch: ["Rice", "Roti", "Dal (Urad)", "Mushroom Peas Aloo Masala", "Peas Masala", "Tindly Fry"],
          Snacks: ["Dahi Vada"],
          Dinner: ["Rice", "Roti", "Aloo Beans Dry", "Beans Dry", "Chole Curry", "Fruit Custard"]
        },
        Friday: {
          Breakfast: ["Mixed Fruit Jam", "Chole", "Green Gram", "Chocos", "Plain Utthappam", "Coconut Chutney", "Mix Veg Sambar"],
          Lunch: ["Rice", "Roti", "Chana Dal", "Chilli Paneer semi dry", "Kadai Mix Veg Curry"],
          Snacks: ["Onion Pakoda"],
          Dinner: ["Rice", "Roti", "Tomato Dal", "Kala Channa Masala Curry", "Watermelon Fruit", "Buttermilk"]
        },
        Saturday: {
          ...
          Dinner: ["Rice", "Roti", "Dal Makhani", "Red Pumpkin Sabji", "Milk + Boost"]
        },
        Sunday: {
          Breakfast: ["Mango/Orange Jam", "Boiled Green Gram", "Oats", "Aloo/Gobi Paratha", "Green Chutney", "Curd"],
          Lunch: ["Mixed Veg Biryani", "Roti", "Raita", "Dal (Toor)", "Kadai Paneer", "Mirchi Ka Salan", "Onion+Tomato+Lemon Salad", "Double Ka Meetha"],
          Snacks: ["Sundal"],
          Dinner: ["Rice", "Dal Fry", "Puri", "Chana Masala", "Mixed Fruit Salad"]
        }
      }
...
//✅
  ...
  TempMenu: {
    ...
    weeks: {
      A: {
        Monday: {
          Breakfast: ["Boiled Egg/Cornflakes(Pure veg)", "Boiled Chawli", "White Pongal", "Groundnut Chutney", "Sambar"],
          Lunch: ["Cucumber Carrot salad", "Kashmiri Pulao/ Tamrind Rice", "Cauliflower masala (gravy)", "Radish Sambar/ Dal (north)", "Gongura thoviyal"],
          Snacks: ["Masala corn & Lemon"],
          Dinner: ["Pudina chapathi", "Roasted egg masala/soya chunk gravy", "Mix veg Sambar/Dal", "Kaddu ka Kheer", "Lemon Water", "Salad"]
        },
        Tuesday: {
          Breakfast: ["Boiled egg/Oats", "Boiled Peanut", "Pav bhaji", "Lime and onion"],
          Lunch: ["Beetroot Tomato Salad", "Veg Biryani (basmati)", "Mix Veg Curry (gravy)", "Mixed dal", "Pepper Rasam", "Mint Thoviyal", "Raita", "Fryums/Papad"],
          Snacks: ["Sweet Potato/Sev Puri"],
          Dinner: ["Chapati/ Idli chutney+sambar", "Black Channa (Gravy)", "Fruit custard", "Buttermilk", "Salad"]
        },
        Wednesday: {
          Breakfast: ["Boiled egg / Chocos", "Green Gram Sprouts", "Vegetable rava upma", "Coconut chutney"],
          Lunch: ["Radish Cucumber Salad", "Variety Rice", "Meal Maker peas (gravy)", "Bhindi Sambar/ Makhana Dal", "Ridge Gourd Thoviyal"],
          Snacks: ["Rusk (4 pieces)"],
          Dinner: ["Methi chapathi", "Jeera Rice", "Kadai Chicken Curry/ Kadai Paneer", "Garlic Rasam", "rava kesari", "Lemon water", "Salad"]
        },
        Thursday: {
          Breakfast: ["Boiled egg / Cornflakes", "Boiled Black Chana", "Pasta", "Tomato Sauce"],
          Lunch: ["Cucumber carrot salad", "Achari Paneer Pulao", "Mor kuzhambu (gravy)", "Palak dal", "Curry Leaf Thoviyal"],
          Snacks: ["Bhel puri"],
          Dinner: ["Boiled Egg pulao/ Veg Pulao", "Sherva", "Roti", "Mixed Dal", "Boiled Sweet corn", "Buttermilk", "Salad"]
        },
        Friday: {
          Breakfast: ["Boiled egg/ Chocos", "Boiled white chana", "Semiya", "Mint chutney"],
          Lunch: ["Beetroot Tomato Salad", "Veg Biryani (Basmati)", "Gutti Vankaya Curry (gravy)/ Cabbage Beans", "Carrot sabzi", "Toor dal/Radish Sambar", "Gongura Thoviyal", "Raita"],
          Snacks: ["Dahi Papdi/Sweet Corn"],
          Dinner: ["Black Channa Curry and roti", "Drumstick sambar/Amritsari Dal", "Tomato Raasam", "Papaya", "Ragi drink/Lemon Drink/ Jaljeera", "Salad"]
        },
        Saturday: {
          Breakfast: ["Boiled egg/Oats", "Boiled green gram", "Poha", "Coconut Chutney/ Imli chutney", "Lime and onion"],
          Lunch: ["Radish Cucumber Salad", "Beetroot Black Channa poriyal (dry)", "Dalma/ Kara Kuzhambu", "Pepper rasam", "Tomato Thoviyal"],
          Snacks: ["Fruit Chaat"],
          Dinner: ["Lemon rice", "Curd rice", "Sambar Rice", "Boost Milk", "Banana fruit", "Potato chips/Fryums", "Salad"]
        },
        Sunday: {
          Breakfast: ["Boiled egg / Cornflakes", "Boiled white peas", "Dalia", "Tamarind chutney/ Coconut Chutney", "Pickle"],
          Lunch: ["Onion lemon Cucumber salad", "Hyderabadi Chicken Dum biryani/ Paneer Dum Biryani [Basmati]", "mirchi ka Salan", "Tomato Rasam", "Raita", "Ice Cream", "Fryums/ Papad"],
          Snacks: ["Chana chaat"],
          Dinner: ["Idiyapam/ Chapathi", "Veg Kurma", "Drumstick Sambar/ Dal", "Watermelon", "Salad", "Buttermilk"]
        }
      },
      B: {
        Monday: {
  ...
  proteinMessVeg: {
    name: "Protein Mess - Veg",
    weeks: {
      A: {
        Monday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji (100gm)", "Thattu Idly", "Brinjal Sambar", "Kara Chutney", "Apple (1)"],
          Lunch: ["Rajma Dal (100gm)", "Panner Butter masala (150gm)", "Pindi chhole (150gm)", "Brocoli (100gm)", "Peas paneer pulao", "Butter Roti", "Green Salad"],
          Snacks: ["Paneer Burji Sandwich"],
          Dinner: ["Green Mong Dal (100gm)", "Bhee aloo (Lotus Stem) (150gm)", "Aloo peas poriyal (100gm)", "Chappathy", "Sambar", "Rasam", "Seasonal Fruit Juice (250ml)"]
        },
        Tuesday: {
          Breakfast: ["Egg Burji (150gms)", "Soya Chunks (100gm)", "Rawa Dosa", "Drumstk Sambar", "GroundNut Chutney", "Orange (1)"],
          Lunch: ["Pancharatna Dal (100gm)", "Mushroom-dopyaza (150gm)", "Sindhi kadhi (150gm)", "Beans poriyal (100gm)", "Steamed Rice", "Doda roti", "Green Moong Sprouts"],
          Snacks: ["Sweet corn (steamed)"],
          Dinner: ["Dal Makkni (100gm)", "Palak Paneer (150gm)", "Ridge gourd in mustard gravy (100gm)", "Multigrain Roti", "Puli kulambu", "Fruit Salad (100 gms)"]
        },
        Wednesday: {
          Breakfast: ["Fried Egg (5 Nos Max)", "Dal pakwaan", "Bananas (1)"],
          Lunch: ["Arhar Dal (100gm)", "Achari Paneer(150gm)", "Bhindi moor kulambu (150gm)", "Cheese fri onion rings (100gm)", "Veg.Briyani", "Raitha", "Phulka", "Mix Salad"],
          Snacks: ["Boiled Sweet Potato"],
          Dinner: ["Mong Dal Tadka (100gm)", "Paneer Butter Masala (150gm)", "Spicy chhole (100gm)", "Jeera Rice", "Masala Kulcha", "Sambar", "Rasam", "Banana Milk Shake (250ml)"]
        },
        Thursday: {
          Breakfast: ["Omlette (5 Nos Max)", "Fried Beans (100gms)", "Idiappam", "Veg stew", "Guava (1)"],
          Lunch: ["Masoor Dal (100gm)", "Ginger garlic paneer(150gm)", "Shahi Paneer (150gm)", "Mushroom 65-(100gm)", "Jeera Butter Rice", "Phulka", "Mix Sprouts Salad"],
          Snacks: ["Moong Sprout Usli"],
          Dinner: ["Rajma Dal (100gm)", "Paneer Navratna (150gms)", "Kabli chana (100gm)", "Butter Kulcha", "Sambar", "Rasam", "Cut fruit (Papaya, Water melon, Musk melon)"]
        },
        Friday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji (100gm)", "Millet pulao", "Chutney", "Pomegranate (1)"],
          Lunch: ["Chickpea Dal (100gm)", "Hariali Paneer (150gm)", "Paneer stuffed Capsicum (150gm)", "Cauliflower steamed with carrots (100gm)", "Mix veg. Briyani", "Raitha", "Butter Roti", "Tossed Salad"],
          Snacks: ["Bhee tikki (Lotus Stem)"],
          Dinner: ["Chikki wale Dal (100gm)", "Paneer keema curry (150gm)", "Aloo Tinde Dry (100gm)", "Jeera Rice", "Ajwain masala Chappathy", "Assorted chutneys", "Seasonal Fruit Juice (250ml)"]
        },
        Saturday: {
          Breakfast: ["Fried Egg (5 Nos Max)", "Soya Chunks (100gm)", "Moong chilla", "Tamarind chutney", "Apple (1)"],
          Lunch: ["Dal Makkni (100gm)", "Light gravy - Tofu ginger chilli fry (150gm)", "Raw Jackfruit Kofta Curry (150gm)", "Mixed saag (100gm)", "Steamed Rice", "Phulka", "Mix Salad"],
          Snacks: ["Murmura Masla Bhel Dry"],
          Dinner: ["Dal fry (100gm)", "Kaju Curry (150gm)", "Carrot capsicum paneer dry fry (100gms)", "Ghee Rice", "Phulka", "Sambar", "Garlic Rasam", "Fruit Salad (100gm)"]
        },
        Sunday: {
          Breakfast: ["Egg Burji (150gm)", "Butter Fried Lima beans (100gms)", "Paneer Paratha", "Plain Curd", "Mix Veg.Pickle", "Orange (1)"],
          Lunch: ["Moong Dal (100gm)", "Gobi in dhania gravy (150gm)", "Steamed paneer, carrot & peas (100gm)", "Hyderabadi Dum Paneer Briyani", "Raitha", "Phulka", "Sprouts Salad"],
          Snacks: ["Aloo Cole Tikki"],
          Dinner: ["Matar Dal (thick) (100gm)", "Chhena dalna (150gm)", "Sarso bhindi (100gm)", "Kulcha", "Sambar", "Tomato Rasam", "Banana Milk Shake (250ml)"]
        }
      },
      B: {
        Monday: {
          ...
          Lunch: ["Rajma Dal (100gm)", "Panner Butter masala (150gm)", "Pindi chhole (150gm)", "Brocoli (100gm)", "Peas paneer pulao", "Butter Roti", "Green Salad"],
          Snacks: ["Paneer Burji Sandwich"],
          Dinner: ["Green Mong Dal (100gm)", "bhee aloo (150gm)", "aloo peas poriyal (100gm)", "Chappathy", "Sambar", "Rasam", "Seasonal Fruit Juice (250ml)"]
        },
        Tuesday: {
          Breakfast: ["Egg Burji (150gms)", "Soya Chunks (100gm)", "Rawa Dosa", "Drumstk Sambar", "GroundNut Chutney", "Orange (1)"],
          Lunch: ["Pancharatna Dal (100gm)", "Mushroom-dopyaza (150gm)", "Sindhi kadhi (150gm)", "beans poriyal (100gm)", "Steamed Rice", "Doda roti", "Green Moong Sprouts"],
        ...
        Wednesday: {
          Breakfast: ["Fried Egg(5 Nos Max)", "Dal pakwaan", "Bananas (1)"],
          Lunch: ["Arhar Dal (100gm)", "Achari Paneer(150gm)", "bhindi moor kulambu (150gm)", "Cheese fri onion rings (100gm)", "Veg.Briyani", "Raita", "Phulka", "Mix Salad"],
          Snacks: ["Boiled Sweet Potato"],
          Dinner: ["Mong Dal Tadka (100gm)", "Paneer Butter Masala (150gm)", "spicy chhole (100gm)", "Jeera Rice", "Masala Kulcha", "Sambar", "Rasam", "Banana Milk Shake (250ml)"]
        },
        Thursday: {
          Breakfast: ["Omlette (5 Nos Max)", "Fried Beans (100gms)", "Idiappam", "Veg stew", "Guavam (1)"],
          Lunch: ["Masoor Dal (100gm)", "Ginger garlic paneer(150gm)", "Shahi Paneer (150gm)", "Mushroom 65-(100gm)", "Jeera Butter Rice", "Phulka", "Mix Sprouts Salad"],
          Snacks: ["Moong Sprout Usli"],
          Dinner: ["Rajma Dal (100gm)", "Paneer Navratna (150gms)", "Kabli chana (100gm)", "Butter Kulcha", "Sambar", "Rasam", "Cut fruit ( Papaya, Water melon, Musk melon )"]
        },
        Friday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji (100gm)", "Millet pulao", "Chutney", "Pomegranate (1)"],
          Lunch: ["Chickpea Dal (100gm)", "Hariali Paneer (150gm)", "Paneer stuffed Capsicum (150gm)", "Cauliflower steamed with carrots (100gm)", "Mix veg. Briyani", "Raita", "Butter Roti", "Tossed Salad"],
          Snacks: ["Bhee tikki"],
          Dinner: ["Chikki wale Dal (100gm)", "Paneer keema curry (150gm)", "Aloo Tinde Dry (100gm)", "Jeera Rice", "Ajwain masala Chappathy", "assorted chutneys", "Seasonal Fruit Juice (250ml)"]
        },
        Saturday: {
        ...
        Sunday: {
          Breakfast: ["Egg Burji (150gm)", "Butter Fried Lima beans (100gms)", "Paneer Paratha", "Mix Veg.Pickle", "Orange (1)"],
          Lunch: ["Moong Dal (100gm)", "Gobi in dhania gravy (150gm)", "Steamed paneer, carrot & peas (100gm)", "Hyderabadi Dum Paneer Briyani", "Raita", "Phulka", "Sprouts Salad"],
          Snacks: ["Aloo Cole Tikki"],
          Dinner: ["Matar Dal (thick) (100gm)", "Chhena dalna (150gm)", "sarso bhindi (100gm)", "Kulcha", "Sambar", "Tomato Rasam", "Banana Milk Shake (250ml)"]
        }
      },
  ...
  proteinMessNonVeg: {
    name: "Protein Mess - Non Veg",
    weeks: {
      A: {
        Monday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji (100gm)", "Milet Idly Beans", "Sambar/Chutney", "Apple (1)"],
          Lunch: ["Rajma Dal (100gm)", "Chili Paneer (150gm)", "Brocoli (100gm)", "Veg.Chineese fried rice", "Butter Roti", "Green Salad"],
          Snacks: ["Egg Sandwich"],
          Dinner: ["Green Mong Dal (100gm)", "Kadai Chicken (150gm)", "Malai Methi Mutter (150gm)", "Aloo Beans n Coconut (100gm)", "Chappathy", "Sambar", "Rasam", "Fruit Salad (100gm)"]
        },
        Tuesday: {
          Breakfast: ["Egg Burji-150gms", "Soya Chunks-100gm", "Ragi Dosa", "Drumstick Sambar", "GroundNut Chutney", "Orange (1)"],
          Lunch: ["Pancharatna Dal (100gm)", "Palak Paneer (150gm)", "Satured mix veg (100gm)", "Green Peas Pulao", "Chappathy", "Green Moong Sprouts"],
          Snacks: ["Corn & Carrot Chaat"],
          Dinner: ["Dal Makkni (100gm)", "Tawa Fish Fry (150gm)", "Mix veg curry (150gm)", "Carrot Beans dry (100gm)", "Masala Kulcha", "Sambar", "Rasam", "Seasonal Fruit Juice-250ml"]
        },
        Wednesday: {
          Breakfast: ["Fried Egg(5 Nos Max)", "Butter Fried Aloo-100gms", "Dalia Upma", "Drumstk Sambar", "Ground Nut Chutney", "Bananas (1)"],
          Lunch: ["Dal lasooni (100gm)", "Mutter Paneer (150gm)", "Cheese fri Peas (100gm)", "Egg Briyani", "Raitha Phulka", "Mix Salad"],
          Snacks: ["Boiled Sweet Potato"],
          Dinner: ["Moong Dal Tadka (100gm)", "Gongura Chicken Dry(150gm)", "Malai Methi Mutter (150gm)", "Aloo Capsicum Dry (100gm)", "Multigrain Roti", "Sambar", "Rasam", "Cut fruit ( Papaya, Water melon, Musk melon )"]
        },
        Thursday: {
          Breakfast: ["Omlette (5 Nos Max)", "Fried Beans-100gms", "Mix Veg Poha (Carrot & Beans)", "Ground Nut Chutney", "Guava (1)"],
          Lunch: ["Masala Dal (100gm)", "Paneer Tikka Masala (150gms)", "Mushroom Pepp fry (100gm)", "Jeera Butter Rice", "Chappathy", "Mix Sprouts Salad"],
          Snacks: ["Moong Sprout Usli"],
          Dinner: ["Rajma Dal (100gm)", "Masala Fried Chicken (150g)", "Kadai Paneer Veg (150gm)", "Mix veg Dry (100gm)", "Butter Kulcha", "Sambar", "Rasam", "Fruit Salad (100gm)"]
        },
        Friday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji-100gm", "Semia Bhath", "Coconut Chutney", "Pomegranate (1)"],
          Lunch: ["Rajma Dal (100gm)", "Kadai Paneer (150gm)", "Brocoli (100gm)", "Mix veg Briyani", "Raith", "Butter Roti", "Tossed Salad"],
          Snacks: ["Chick Peas Sundal"],
          Dinner: ["Chikki wale Dal (100gm)", "Kadai Chicken (150gm)", "Mutter PaneerCapsi (150gm)", "Aloo Bhindi Dry (100gm)", "Methi Chappathy", "Sambar", "Rasam", "Seasonal Fruit juice - 250ml"]
        },
        Saturday: {
          Breakfast: ["Fried Egg(5 Nos Max)", "Soya Chunks-100gm", "Set Dosa", "Drumstk Sambar", "Ash Gourd Chutney", "Apple (1)"],
          Lunch: ["Dal Makkni (100gm)", "Chili Paneer (150gm)", "Satured mix veg (100gm)", "Paneer Fried Rice", "Phulka", "Mix Salad"],
          Snacks: ["Murmura Masala Bhel Dry"],
          Dinner: ["Dal fry (100gm)", "Mutton Rajangosh(150gm)", "Malai Kofta Curry (150gm)", "Carrot Beans dry (100gm)", "Phulka", "Sambar", "Rasam", "Cut-fruit(Papaya, Watermelon, Musk melon )"]
        },
        Sunday: {
          Breakfast: ["Egg Burjii-150gm", "Butter Fried Aloo-100gms", "Gobi Beetroot Methi Paratha", "Plain Curd", "Mix Veg.Pickle", "Orange (1)"],
          Lunch: ["Rajma Dal (100gm)", "Palak Paneer (150gm)", "Cheese fri Peas (100gm)", "Chicken Briyani", "Raitha", "Phulka", "Sprouts Salad"],
          Snacks: ["Aloo Cole Tikki"],
          Dinner: ["Masala Dal Tadka (100gm)", "Soya Chunk Palak Dry (150gm)", "Aloo Gobi Achari (150gm)", "Mix veg Dry (100gm)", "Masala Kulcha", "Sambar", "Rasam", "Cut fruit ( Papaya, Water melon, Musk melon )"]
        }
      },
      B: {
        Monday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji (100gm)", "Thattu Idly", "Brinjal Sambar", "Kara Chutney", "Apple (1)"],
          Lunch: ["Rajma Dal (100gm)", "Chicken masala (150gm)", "Pindi chhole (150gm)", "Brocoli (100gm)", "Peas paneer pulao", "Butter Roti", "Green Salad"],
          Snacks: ["Egg Sandwich"],
          Dinner: ["Green Mong Dal (100gm)", "bhee aloo (150gm)", "aloo peas poriyal (100gm)", "Chappathy", "Sambar", "Rasam", "Seasonal Fruit Juice (250ml)"]
        },
        Tuesday: {
          Breakfast: ["Egg Burjii (150gms)", "Soya Chunks (100gm)", "Rawa Dosa", "Drumstk Sambar", "Groundnut Chutney", "Orange (1)"],
          Lunch: ["Pancharatna Dal (100gm)", "Fish dopyaza (150gm)", "Sindhi kadhi (150gm)", "beans poriyal (100gm)", "Steamed Rice", "Doda roti", "Green Moong Sprouts"],
          Snacks: ["sweet corn (steamed)"],
          Dinner: ["Dal Makkni (100gm)", "Palak Paneer (150gm)", "Ridge gourd in mustard gravy (100gm)", "Multigrain Roti", "puli kulambu", "Fruit Salad (100 gms)"]
        },
        Wednesday: {
          Breakfast: ["Fried Egg(5 Nos Max)", "D al pakwaan", "Bananas (1)"],
          Lunch: ["Arhar Dal (100gm)", "Chettinad Chicken(150gm)", "bhindi moor kulambu (150gm)", "Cheese fri onion rings (100gm)", "Egg Briyani /Veg.Briyani with Raitha", "Phulka", "Mix Salad"],
          Snacks: ["Boiled Sweet Potato"],
          Dinner: ["Mong Dal Tadka (100gm)", "Paneer Butter Masala (150gm)", "spicy chhole (100gm)", "Jeera Rice", "Masala Kulcha", "Sambar", "Rasam", "Banana Milk Shake (250ml)"]
        },
        Thursday: {
          Breakfast: ["Omlette (5 Nos Max)", "Fried Beans (100gms)", "Idiappam", "Veg stew", "Guavam (1)"],
          Lunch: ["Masoor Dal (100gm)", "Ginger garlic chicken(150gm)", "Shahi Paneer (150gm)", "Mushroom (65-100gm)", "Jeera Butter Rice", "Phulka", "Mix Sprouts Salad"],
          Snacks: ["Moong Sprout Usli"],
          Dinner: ["Rajma Dal (100gm)", "Paneer Navratna (150gms)", "Kabli chana (100gm)", "Butter Kulcha", "Sambar", "Rasam", "Cut fruit ( Papaya, Water melon, Musk melon )"]
        },
        Friday: {
          Breakfast: ["Boiled Egg (5 Nos Max)", "Paneer Burji (100gm)", "Millet pulao", "Chutney", "Pomegranate (1)"],
          Lunch: ["Chickpea Dal (100gm)", "Hariali Chicken (150gm)", "Paneer stuffed Capsicum (150gm)", "Cauliflower steamed with carrots (100gm)", "Mix veg. Briyani", "Raitha", "Butter Roti", "Tossed Salad"],
          Snacks: ["Bhee tikki"],
          Dinner: ["Chikki wale Dal (100gm)", "Paneer keema curry (150gm)", "Aloo Tinde Dry (100gm)", "Jeera Rice", "Ajwain masala Chappathy", "assorted chutneys", "Seasonal Fruit Juice (250ml)"]
        },
        Saturday: {
          Breakfast: ["Fried Egg(5 Nos Max)", "Soya Chunks (100gm)", "Moong chilla", "Tamarind chutney", "Apple (1)"],
          Lunch: ["Dal Makkni (100gm)", "Mutton stew(150gm)", "Raw Jackfruit Kofta Curry (150gm)", "Mixed saag (100gm)", "Steamed Rice", "Phulka", "Mix Salad"],
          Snacks: ["Murmura Masla Bhel Dry"],
          Dinner: ["Dal fry (100gm)", "Kaju Curry (150gm)", "Carrot capsicum paneer dry fry (100gms)", "Ghee Rice", "Phulka", "Sambar", "Garlic Rasam", "Fruit Salad (100gm)"]
        },
        Sunday: {
          Breakfast: ["Egg Burjii (150gm)", "Butter Fried Lima beans (100gms)", "Paneer Paratha", "Plain Curd", "Mix Veg.Pickle", "Orange (1)"],
          Lunch: ["Moong Dal (100gm)", "Gobi in dhania gravy (150gm)", "Steamed paneer, carrot & peas (100gm)", "Hyderabadi Dum Chicken Briyani", "Raitha", "Phulka", "Sprouts Salad"],
          Snacks: ["Aloo Cole Tikki"],
          Dinner: ["Matar Dal (thick) (100gm)", "Chhena dalna (150gm)", "sarso bhindi (100gm)", "Kulcha", "Sambar", "Tomato Rasam", "Banana Milk Shake (250ml)"]
        }
      },
